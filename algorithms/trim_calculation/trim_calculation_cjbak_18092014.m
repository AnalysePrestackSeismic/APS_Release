function [] = trim_calculation(job_meta_path,i_block,startvol,endvol,shift,zsmooth,itm,otm,timbal)
%% ------------------ Disclaimer  ------------------
% 
...
%   startvol:       The smallest angle trace to load 
%   endvol:         The largest angle trace to load
%   shift:          Maximum allowable shift in samples ??
%   zsmooth :       Smoother ?? 
%   itm:            Inner Trace Mute 
%   otm:            Outer Trace Mute 
%   timbal:         Balancing ?? 
...
% ============================================================================================================
% sort out parameters
smoothing_scaler = 3;  % normally 10
