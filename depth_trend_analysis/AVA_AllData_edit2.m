function AVA_AllData_edit2(Zpred,Zwc,Pop,Sand,Comp,GA,Shale,FitType,NI)
%% ------------------ Disclaimer  ------------------
% 
...
WinNo=5; % Non-linear, normalising data decimation - larger the number the greater the decimation of closely spaced data. 1=all data
OB_Scalar=1; % This can be used to increase non-linear decimation in higher sampled mudstone intervals

% Pressure filtering
Pco=10000; % Only include data in depth trend analysis which is at close to hydrostatic pressure (i.e. < Pco psi overpressued), 0=only hydrostatic - 10000=all data.
...
% Anisotropy
delta1=0.12; % Overburden 
delta2=0; % Reservoir
epsilon1=0.2; % Overburden
