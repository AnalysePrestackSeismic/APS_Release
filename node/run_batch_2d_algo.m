function[]=run_batch_2d_algo(input_filepath,filename_string,output_filepath,il_byte,xl_byte,offset_byte,anggath,algorithm_name,slurm_part,n_cores,startvolr,endvolr,shift,zsmooth,itmr,otmr,timbal,outputflatgathers)
...
for g=1:nfiles
    batch_run_file_info.algo_run_qc{g}=node_slurm_submit2013_CAN(algorithm_name,job_meta_files{g},slurm_part,n_cores,startvolr,endvolr,shift,zsmooth,itmr,otmr,timbal,outputflatgathers);
    pause(10);
