clear all
[filter_files,nfiles] = directory_scan({'/data/TZA/petrel/Petrel_2013/Working/Block_1/Exploration/wallisj/Paleoscan_Depth_Surfaces/Kusini_Infill/'},'Geo'); %directory_scan({'/data/TZA/Data/interp_export/2014Grids/Depth/'},'hrd_skip');
il_xl = 0;
