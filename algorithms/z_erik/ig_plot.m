...
function [] = ig_plot( job_meta_path,block,int_dir,grad_dir,maxz,win_chi,inc_chi,int_dp_lim,grad_dp_lim,post_process_flag)
...
% digi_noQ_trim PATH
%int.filename='/data/TZA/segy/2013_pweza_chewa_presdm_pgs/gather_for_eage/digi_noQ_trim/digi_results/digi_intercept_w_range_7_1_31/digi_intercept_w_range_7_1_31_block_1.segy'; % Erik - bypass filename construction
%grad.filename='/data/TZA/segy/2013_pweza_chewa_presdm_pgs/gather_for_eage/digi_noQ_trim/digi_results/digi_gradient_w_range_7_1_31/digi_gradient_w_range_7_1_31_block_1.segy'; % Erik - bypass filename construction

% digi_Q_trim PATH
int.filename='/data/TZA/segy/2013_pweza_chewa_presdm_pgs/gather_for_eage/digi_Q_trim/digi_results/digi_intercept_w_range_7_1_31/digi_intercept_w_range_7_1_31_block_1.segy'; % Erik - bypass filename construction
grad.filename='/data/TZA/segy/2013_pweza_chewa_presdm_pgs/gather_for_eage/digi_Q_trim/digi_results/digi_gradient_w_range_7_1_31/digi_gradient_w_range_7_1_31_block_1.segy'; % Erik - bypass filename construction

% digi_offset_trim PATH
%int.filename='/data/TZA/segy/2013_pweza_chewa_presdm_pgs/gather_for_eage/digi_offset_trim/digi_results/digi_intercept_w_range_1_1_6/digi_intercept_w_range_1_1_6_block_1.segy'; % Erik - bypass filename construction
%grad.filename='/data/TZA/segy/2013_pweza_chewa_presdm_pgs/gather_for_eage/digi_offset_trim/digi_results/digi_gradient_w_range_1_1_6/digi_gradient_w_range_1_1_6_block_1.segy'; % Erik - bypass filename construction
...
cpa_directory = strcat('/data/TZA/segy/2013_pweza_chewa_presdm_pgs/gather_for_eage/crossplot_analysis','_',maxz,'_',win_chi,'_',inc_chi,'_',int_dp_lim,'_',grad_dp_lim,'_',post_process_flag,'/'); % The name of the crossplot analysis directory
