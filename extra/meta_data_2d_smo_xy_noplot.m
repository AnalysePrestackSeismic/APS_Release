function [ ] = meta_data_2d_smo_xy_noplot( job_meta_path )
%% ------------------ Disclaimer  ------------------
% 
...
fprintf('loaded job_meta file %s \n',job_meta_path);
...
count = 1;                                      % Counter
%%
fprintf('total live blocks is: %d \n',loopfin);
...
fprintf('starting filtering half size of filter is: %d \n',flen);
...
fprintf('writing SD for this many wavelets: %d \n',size(ilxl_lookup_smoout));
