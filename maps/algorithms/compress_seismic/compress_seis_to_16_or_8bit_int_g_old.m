...
for ckk = 1:no_of_traces
    ...
    if sum(trim_data(:,ckk)) ~= 0;
        ...
        %[itpslocsin, itpsval] = upr_envlop(itpsval, itpslocsin,firstpos, endpos, intrlen, origcount, origuprloc, origuprval, itpslocstest);
        ...
        %[mitpslocsin, mitpsval] = lwr_envlop(mitpsval, mitpslocsin,firstneg, endneg, intrlen, origcount, origlowloc, origlowval, itpslocstest);
