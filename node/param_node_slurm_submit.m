...
% https://github.com/AnalysePrestackSeismic/
%% ------------------ FUNCTION DEFINITION ---------------------------------
	altnodes = {'ip-172-31-42-198'}; % {'sblxpghn100 ','sblxpgcn192 ','sblxpgcn182 '}
	mcr_root = '/data/apps/mcr/v81'; % path location to matlab install or MCR
	mcr_cache_root = '/tmp/'; % '/localcache/mcr_cache_umask_friendly/'; % suitable temp location
	run_script_path = '/data/apps/maps/aws_cloud_test/'; % path location to compiled matlab algorithms
