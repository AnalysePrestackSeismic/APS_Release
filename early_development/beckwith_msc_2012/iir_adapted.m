function I2= iir_adapted(filename,f,varargin)
...
%
% Adapted by James Beckwith <py06jab@leeds.ac.uk> to accept an array of
% values instead of an image file. Output is now as double rather than integer.
%
...
switch method
	case 'linear'
		yy = (interp1(y,xx,'linear'));
	case 'spline'
		yy = (interp1(y,xx,'spline'));
	case 'pchip'
		yy = (interp1(y,xx,'pchip'));
	case 'cubic'
		yy = (interp1(y,xx,'cubic'));
	case 'v5cubic'
		yy = (interp1(y,xx,'v5cubic'));
    end
end