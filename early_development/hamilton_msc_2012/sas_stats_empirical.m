function[average,variance] = sas_stats_empirical(data_file_in,time_file_in,bytespersample,nt,ntwin,olap,run_number)
%
...
if data(j,1) > 1e29
    ...
    resort_prob = zeros(ntrace1-length(a),1);   
    ...
    for k = 1:(ntrace1-length(a))
      ...
      value = emp_pos(emp_pos == data(g(1,k),1));
     
      resort_prob(g(k),1) = emp_prob(value); 
       
      else
          
      resort_prob(g(k),1) = 1e30;
