function segy_make_structure(filepath,il_byte,xl_byte,offset_byte,anggath,filename,yp_byte,xp_byte)
%% ------------------ Disclaimer  ------------------
% 
...
yp_byte = str2double(yp_byte);                                  % X-line byte location from argument
xp_byte = str2double(xp_byte);                                  % X-line byte location from argument
