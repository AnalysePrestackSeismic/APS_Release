function [ wavelets ] = load_wavelet_spatial_CAN(job_meta_path,wavelet_dir_path,i_block,algo)
%% ------------------ Disclaimer  ------------------
% 
...
%%
        ...
        w_avg = [w_proc(2,:); bsxfun(@rdivide,w_proc(3:end,:),max(w_proc(2,:)))];                                % Averaging over all traces: Divide the summation of spectrums by total number of live traces  for all windows
