...
%   Detailed explanation goes here
    ...
    for ij = 1:process_files.nfiles
        
        [traces_tmp, process_positions] = node_segy_read_traces(block_mat_all,block_mat,process_files_mat,ij);
        ...
        wavelet{1,ij} = make_wavelet(ft_traces_tmp,wavelet_length);
        wavelet{1,ij} = [coords;wavelet{1,ij}];
