...
%   will create a mat file in the location of the input SEGY defining the
%   structure of the input file.
% Example scan: segy_make_structure_lite_tg('/data/NOR/segy/hegg_fwi_test_2012/gathers/','run3_hegg_fwi_model_vti_full_area_starting_model.segy',189,193,37)
%%-------------------------------------------------------------------------
