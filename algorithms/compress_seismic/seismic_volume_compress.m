function segy_poly_io(filename)
%% ------------------ Disclaimer  ------------------
% 
...
blocktr = 10;                                        % Edit this number if you want to change size of blocks
...
out_file_name = strcat(filename,'_compres16.sgy');
...
% do something with the traces
    ...
    % compress the traces
    tracesout =  compress_seismic_to_16_int(traces);
    %tracesout =  compress_seismic_to_8_int(traces);
