function[angle] = crossplotter7(Yaxisfile,Xaxisfile,Time_Volume, nt,ntwin,bytespersample, divisions, run_number, no_xlines,no_inlines, no_bins,no_inline_bin)
...
%         plotangle(1:length(timeslice(l).intdata)) = 0;
          ...
          count3 = count3 + 1;
          count = count +1;
          plotangle(1:length(indexor)) = PCA(l).DEG;        
