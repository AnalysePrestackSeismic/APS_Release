function segy_poly_io_tza_statoil_psdm(xloc_byte,yloc_byte,path,filestr)
%% ------------------ Disclaimer  ------------------
% 
...
[files_in,nfiles] = directory_scan(path,filestr);

for i_file = 1:1:nfiles

%[files_in,nfiles] = directory_scan('/data/TZA/segy/statoil_seismic_trade/','ln_');

% Tanzania PreSDM Block 1 Statoil seismic trade 
xv = [635575.77
688718.67
692404.66
657863.24
...
% Read input file
filename = [files_in.path{i_file},files_in.names{i_file}];
