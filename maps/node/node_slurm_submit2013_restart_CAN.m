 function [str_qc] = node_slurm_submit2013_restart_CAN(algorithm_name,job_meta_path,slurm_part,n_cores,current_wckey,varargin)
%% ------------------ Disclaimer  ------------------
% 
...
str_qc=sprintf('sacct --format=JobName%%-30,jobid,elapsed,Start,End,ncpus,ntasks,state,wckey%%-40,nodelist --allusers --starttime=%s  --wckey=%s%s%s\n',datemonprev,randdir,'_',algorithm_name);
