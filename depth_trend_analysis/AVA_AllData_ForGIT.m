function AVA_AllData_ForGIT(Zpred,Zwc,Pop,Sand,Comp,GA,Shale,NI)
...
% Example Input 
% AVA_AllData_ForGIT(1995,1185,0,0.05,0,40,1,5000)
...
RhoW=1; % Formation brine density g/cc
RhoG=0.2; % Fomration gas density g/cc
...
% Create plot
scatterhist(AI_r,VpVsR_r,'Marker','.','MarkerSize',5,'Group',Lith,'LineStyle',{'-','-','-','-'},'LineWidth',[2,2,2,2]);
