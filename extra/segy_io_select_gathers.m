function [] = segy_io_select_gathers(job_meta_path,i_block,startvol,volinc,endvol,angwidth,tottracerun)
%% ------------------ Disclaimer  ------------------
% 
...
%         
%         angle_stk = squeeze(sum(vol_tracestmp,2)) ./ kdsb;
%         
%     end
end
ns = size(vol_traces,1);
ntraces = size(vol_traces,2);
...
results_out{resultno,2} = vol_traces;
