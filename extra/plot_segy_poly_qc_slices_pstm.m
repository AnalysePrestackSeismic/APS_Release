function plot_segy_poly_qc_slices_pstm( str1,str2,str3 )
%% ------------------ Disclaimer  ------------------
% 
...
caxis([(-1*colrngcj) colrngcj]);
colorbar;
title(sprintf('%s',filepathin),'Interpreter', 'none');
